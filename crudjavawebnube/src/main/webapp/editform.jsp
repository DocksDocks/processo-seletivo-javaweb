...
<body>
	<%@ page
		import="com.crudjavawebnube.bean.Usuario, com.crudjavawebnube.dao.UsuarioDao"%>
	<%
...
%>
	...
	<table>
		...
		<tr>
			<td>Nacionalidade:</td>
			<td><select name="nacionalidade">
					<option>Brasileiro</option>
					<option>Estrangeiro</option>
			</select></td>
		</tr>
		<tr>
			<td colspan="2"><input type="submit" value="Editar Usuário">
			</td>
		</tr>
	</table>
	</form>
